...
turn your documents into smart electronic documents that can be verified
by your intended recipients independently and to facilitate title ownership
transfer, legally and in compliance with globally-accepted standards. All
from the convenience of your enhanced IT system that you are familiar with.</p>
...
<p>With TradeTrust, anyone can <strong>digitise any document</strong> and <strong>effect title transfer</strong> for
titled document<strong> </strong>like bill of lading which is portable <strong>across different digital platforms </strong>of
...
<p>You can refer to a sample TradeTrust-issued document with QR code using
TradeTrust Verify Doc service (available online as a reference implementation):</p>
...
be easily verified. Furthermore, it does not facilitate the transfer of
